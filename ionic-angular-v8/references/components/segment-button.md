...
Add `IonSegmentButton` to the component's `imports: []` array.

## Properties

| Prop | Attribute | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `contentId` | `content-id` | `string \| undefined` |  | The `id` of the segment content. |
| `disabled` | `disabled` | `boolean` | `false` | If `true`, the user cannot interact with the segment button. |
| `layout` | `layout` | `"icon-bottom" \| "icon-end" \| "icon-hide" \| "icon-start" \| "icon-top" \| "label-hide" \| undefined` | `'icon-top'` | Set the layout of the text and icon in the segment. |
...
| `value` | `value` | `number \| string` | `'ion-sb-' + ids++` | The value of the segment button. |
